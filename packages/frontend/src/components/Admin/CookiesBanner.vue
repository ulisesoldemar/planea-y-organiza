<template>
    <div style="position: fixed; bottom: 40px; right: 40px; z-index: 1000;">
      ...
      <v-card width="700" class="px-2 pt-2 elevation-5">
      <v-banner
        avatar="https://cdn.vuetifyjs.com/docs/images/logos/v.svg"
        stacked
      >
        <template v-slot:text>
          P&O Usa cookies para habilitar and import the use of the website. utiliza cookies para habilitar e importar el uso del sitio web. Por favor, consulte nuestras
          <a href="https://www.iubenda.com/privacy-policy/76325752/cookie-policy" target="_blank">Politicas de Privacidad</a> 
          para más información. Al hacer clic en "Aceptar cookies" o continuar utilizando el sitio, acepta el uso de cookies.
        </template>
    
        <template v-slot:actions>
          <v-dialog v-model="dialog" max-width="500" z-index="9999">
          ...
          <v-btn
            class="text-none ms-4 mb-2 text-white"
            color="blue-darken-4"
            variant="flat"
          >
            Aceptar Cookies
