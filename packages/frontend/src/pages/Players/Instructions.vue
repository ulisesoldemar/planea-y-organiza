<template>
  <div
    class="justify-center h-screen d-flex align-center"
    style="background-color: #f5f5f5"
  >
    <div class="text-center">
      <v-card
        class="mb-5 pa-3 mx-auto elevation-4"
        width="500"
        max-width="500"
        height="550"
        max-height="550"
      ...
      >
        ...
        <v-card-text class="mt-15" v-if="item.num == 7">
            <p class="text-h6">
                <span class="font-weight-black"> ¿Estas listo para comenzar? </span> <br> Haz click en el siguiente boton
            </p>
        </v-card-text>
