<template>
    <v-card class="mx-auto" style="max-width: 500px;">
        ...
        <v-form ref="form" v-model="isValid" class="pt-6 pa-4">
            ...
            <v-text-field v-model="phone" variant="filled" color="deep-purple" label="Phone number"></v-text-field>
            <v-text-field v-model="email" :rules="[rules.email]" variant="filled" color="deep-purple" label="Email address"
                type="email"></v-text-field>
            <v-textarea v-model="bio" auto-grow variant="filled" color="deep-purple" label="Bio" rows="1"></v-textarea>
